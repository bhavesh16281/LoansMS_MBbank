...
import com.bhavesh16281.loans.DTO.ResponseDto;
import com.bhavesh16281.loans.service.LoansService;
...
public class LoansController {
    ...
    @GetMapping("/fetch")
    public ResponseEntity<LoansDto> fetchLoanDetails(@RequestHeader("MBBank-correlation-id") String correlationId, @RequestParam
                                                     @Pattern(regexp="(^$|[0-9]{10})",message = "Mobile number must be 10 digits")
                                                     String mobileNumber) {
        logger.info("Fetching loan details for mobile number: {}", mobileNumber);
